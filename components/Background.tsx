...
/*
 * Original background code by Codrops
...
const Background = forwardRef<HTMLDivElement, React.HTMLProps<HTMLDivElement>>((props, ref) => (
  <div className='background' {...props} ref={ref}>
    <svg
    ...
    >
      <path
        d='M17.112,20.996c0.525-0.374,1.001-0.731,1.399-1.031l0.303-0.229c1.35-1.013,2.756-1.527,4.182-1.527
      ...
      />
      <path
        d='M35.667,29.602c0.187-0.178,0.375-0.362,0.567-0.553c2.845-2.844,4.245-5.303,4.245-5.303
      ...
      />
      <path
        d='M19.409,20.53c-2.003,1.503-6.365,4.963-9.887,4.247c0,0,1.856,3.258,5.625,7.028c0.253,0.253,0.503,0.496,0.751,0.732
